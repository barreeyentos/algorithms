...
public class LongestCommonString {
    ...
    public static void main(String... args) {
        LongestCommonString solver = new LongestCommonString();
        test(solver, "geaksforgeeks", "geeksquiz");
    ...
    public static void test(LongestCommonString solver, String string1, String string2) {
